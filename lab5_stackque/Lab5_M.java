...
public class Lab5_M {
    public static void main(String[] args) {
        ...
        undoStack.push("Typed: Good");
        undoStack.push("Added space");
        undoStack.push("Typed: Morning!");
        undoStack.display();
        ...
        customerQueue.enqueue("Customer X");
        customerQueue.enqueue("Customer Y");
        customerQueue.enqueue("Customer Z");
